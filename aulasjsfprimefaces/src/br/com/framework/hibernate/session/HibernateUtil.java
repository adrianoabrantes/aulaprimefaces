...
/**
 * Resposavem por estabelecer a conexao com hibernate
 * 
 * @author Adriano Abrantes
 *
 */
@ApplicationScoped
public class HibernateUtil implements Serializable {
	...
	/**
	 * Resposavel por ler o arquivo de configuracao hibernate.cfg.xml
	 * 
	...
	private static SessionFactory buildSessionFactory() {
		try {
			...
			e.printStackTrace();
			throw new ExceptionInInitializerError("Erro ao criar cenexao SessionFactory");
		}
	}
	 ...
	 * 
	 * @return {@link ConnectionException} SQL
	 * @throws SQLException
	 */
