...
public class implementacaoCrud<T> implements InterfaceCrud<T> {
	...
	@Autowired
	private SimpleJdbcClassImple simpleJdbcClassImple;
	...
	public SimpleJdbcClassImple getSimpleJdbcClassImple() {
		return simpleJdbcClassImple;
	}
	...
	public List<T> findList(Class<T> entidade) throws Exception {
		validaSessionFactory();
		StringBuilder query = new StringBuilder("Select distinct(entity)");
	...
	@Override
	public void execteUpdateQueryDinamic(String s) throws Exception {
		validaSessionFactory();
	...
	@Override
	public SimpleJdbcInsert getSipleJdbcInsert() {
		return simpleJdbcInsert;
	}

	@Override
	public Long totalRegistro(String table) throws Exception {
		StringBuilder sql = new StringBuilder("select conut(1) from ");
		sql.append(table);
